...
class LandingPage extends Component {
  handleContactClick = () => {
    window.location.href = `mailto:sophieuyenthyngo@gmail.com?subject=Wedding Videography&body=Hi Sophie!`;
  }
  render() {
    return (
      <div className="LandingPage">
        <h1>Sundream Films</h1>
        <p className="italic">Wedding Videography For You</p>
        ...
        <button onClick={this.handleContactClick} className="contact-btn">Contact</button>
        <PhotoBar />
        <VideoPlayer />
        <PackagesSection />
      </div>
